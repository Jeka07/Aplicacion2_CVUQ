 ...
 * @version 1.0
 */
public class AdaptadorDeGrupoSolicitudes extends RecyclerView.Adapter<AdaptadorDeGrupoSolicitudes.GrupoViewHolder> {
     ...
     */
    public AdaptadorDeGrupoSolicitudes(ArrayList<Grupo> grupos, ListaDeSolicitudesFragment listaDeGruposFragment) {
        this.grupos = grupos;
