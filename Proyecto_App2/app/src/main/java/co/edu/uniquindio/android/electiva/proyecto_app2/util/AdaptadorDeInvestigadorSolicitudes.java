 ...
 * para el fragmento ListaDeSolicitudes
 *
 ...
 * @version 1.0
 */
public class AdaptadorDeInvestigadorSolicitudes extends RecyclerView.Adapter<AdaptadorDeInvestigadorSolicitudes.IntegranteViewHolder> {
     ...
     */
    public AdaptadorDeInvestigadorSolicitudes(ArrayList<Investigador> investigadors, ListaDeSolicitudesFragment investigadoresFragment) {
    ...
    public IntegranteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdaptadorDeInvestigadorSolicitudes.IntegranteViewHolder integranteVH = new AdaptadorDeInvestigadorSolicitudes.IntegranteViewHolder(itemView);
        return integranteVH;
    }
