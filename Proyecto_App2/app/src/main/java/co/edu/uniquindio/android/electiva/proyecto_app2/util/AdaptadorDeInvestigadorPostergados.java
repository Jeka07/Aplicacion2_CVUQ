 ...
 * @version 1.0
 */
public class AdaptadorDeInvestigadorPostergados extends RecyclerView.Adapter<AdaptadorDeInvestigadorPostergados.IntegranteViewHolder> {
     ...
     */
    public AdaptadorDeInvestigadorPostergados(ArrayList<Investigador> investigadors,
                                              SolicitudesPostetgadasFragment investigadoresFragment) {
    ...
    public IntegranteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AdaptadorDeInvestigadorPostergados.IntegranteViewHolder integranteVH =
                new AdaptadorDeInvestigadorPostergados.IntegranteViewHolder(itemView);
        return integranteVH;
    }
